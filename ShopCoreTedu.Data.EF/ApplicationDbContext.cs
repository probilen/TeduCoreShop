...
using ShopCoreTedu.Data.EF.Configurations;
...
namespace ShopCoreTedu.Data.EF
{
    public class ApplicationDbContext : IdentityDbContext<AppUser,AppRole,Guid>
    {
        ...
        {
            #region Identity configure to sync with AppUser and AppRole
            ...
            #endregion
            #region Add Fuent API to configure Table 
        ...
        {
            //Get all những object is being created || Modified
